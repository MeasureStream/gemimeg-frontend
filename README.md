...
```
cd existing_repo
git remote add origin https://itgit.bs.ptb.de/op-layer/gemimeg-frontend.git
git branch -M master
...
- [ ] [Set up project integrations](https://itgit.bs.ptb.de/op-layer/gemimeg-frontend/-/settings/integrations)
